function final_plot(a,numTarChargers,userConfig,start_point,start_pCharger)
...
for ic = 1:numTarChargers
    for id = 1:NUm(ic)
       plot(a.xy(a.charging_location(count_p),1), a.xy(a.charging_location(count_p),2),C(ic),'linewidth',2,'MarkerSize',20,'MarkerEdgeColor',clr(s+ic,:),'MarkerFaceColor',clr(s+ic,:))
       text(a.xy(a.charging_location(count_p),1)-.2,a.xy(a.charging_location(count_p),2),num2str(id+2),'color','w','FontSize',14)
       count_p = count_p +1;
    end
end
