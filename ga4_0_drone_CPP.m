function varargout = ga4_0_drone_CPP(varargin)
...
%         userConfig.asy2_xy
        ...
        record_dist_charging = zeros(cycle_charging,2+nSalesmen);  %  distance, charging pattern, involved worker1, worker2, worker3   ,2x5
        ...
        for cycle = 1:cycle_charging   %1~2 ~ ... nth 
            ...
            if num_robot == 3
                ...
                record_dist_charging(cycle,:) = [M_min I_min 1 1 1]; %  distance, charging pattern, involved nth robots
            elseif num_robot == 2
                numberToFind = cycle;  % find the same cycle robot
                ...
                record_dist_charging(cycle,:) = [M_min I_min worker1 worker2 worker3]; %  distance, charging pattern, involved nth robots
            else % num_robot == 1 
                numberToFind = cycle;  % find the same cycle robot
