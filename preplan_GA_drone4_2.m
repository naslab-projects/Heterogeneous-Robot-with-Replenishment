...
v = 8/scala; %3/scala; % worker speed   3km/hr with 2hr safety level   % change the drone speed 
...
btl = 4; %8, 10; % battery life  max 12 hr battery 
...
if 1 % "1" for single run, "0" for multiple runs using parallel computing
    a = ga4_2_drone_CPP(userConfig); % use instant charge and speed limit constraint
    Run_time = toc/60
