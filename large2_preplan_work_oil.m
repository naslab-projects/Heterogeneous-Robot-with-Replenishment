...
map1 = Map_mh('oilspill_3.png','resolution',4);
map = Map_mh('oilspill_3.png','resolution',4);
represent(map)
lawn_mower(map)
...
start_point = [19,19];
start_pCharger = [19,19;19,19;19,19;19,19;19,19;19,19;19,19];
...
userConfig.popSize=400*2*2*10; % population size
userConfig.numIter = 600*2*10;     % number of max iteration
