...
plot(start_point(1,1),start_point(1,2),'pentagram','MarkerSize',15,'LineWidth',1,'Color',dark_red); hold on;
plot(start_point(2,1),start_point(2,2),'pentagram','MarkerSize',15,'LineWidth',1,'Color',dark_red,'HandleVisibility','off')
...
title(hAx,sprintf('UAV Travel Distance = %1.2f, Charging Distance = %1.2f',a.minDist,a.minds));
...
yticks(1:4);
yticklabels({'AUV1-1','AUV1-2','AUV2-1','AUV2-2'});
