function varargout = ga4_1_drone_CPP(varargin)
...
%         userConfig.asy2_xy
        ...
        charging_arrange(p).data = record_dist_charging; % record all charging arrangement in each gene 800 
...
%         end
        ...
        fun(p) = alpha_ratio(iter,1)*energy_cost(p) + 0.1*total_ds(p);
